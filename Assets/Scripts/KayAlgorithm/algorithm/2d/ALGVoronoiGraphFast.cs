...
//{
//    LogicPathSet.FbxResourcePath = Application.dataPath;
//    KayAlgorithm.Voronoi2.Voronoi voronoi = new KayAlgorithm.Voronoi2.Voronoi();
//    testx.Clear();
//    testy.Clear();
//    HashSet<string> tempCache = new HashSet<string>();
//    for (int i = 0; i < 10; ++i)
//    {
//        for (int j = 0; j < 10; ++j)
//        {
//            Vector2 temp = RandomUtils.GetRandomVector2(0, 10, 0, 10);
//            string tempKey = string.Format("{0}_{1}", Math.Round(temp[0], 2), Math.Round(temp[1], 2));
//            if (!tempCache.Contains(tempKey))
//            {
//                tempCache.Add(tempKey);
//                testx.Add(temp[0]);
//                testy.Add(temp[1]);
//            }
//        }
...
//    edges = voronoi.generateVoronoi(testx.ToArray(), testy.ToArray(), 0, 10, 0, 10.0f);
...
//    if (edges != null)
//    {
//        foreach (KayAlgorithm.Voronoi2.GraphEdge edge in edges)
//        {
//            Debug.DrawLine(new Vector2((float)edge.x1, (float)edge.y1), new Vector2((float)edge.x2, (float)edge.y2), Color.red);
//        }
//        for (int i = 0; i < testx.Count; ++i)
//        {
//            Vector2 temp = new Vector2((float)testx[i], (float)testy[i]);
//            Debug.DrawLine(temp, temp + incre, Color.green);
//        }
//    }
//}
