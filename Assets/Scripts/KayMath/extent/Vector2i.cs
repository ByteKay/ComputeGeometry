...
namespace KayMath
{
    public class Vector2if
    {
        public class Vector2ifCompare : IComparer<Vector2if>
        {
            public int Compare(Vector2if a, Vector2if b)
            {
                return a.mValue.CompareTo(b.mValue);
            }
        }
        public static Vector2ifCompare DEFAULT = new Vector2ifCompare();
        public int mIndex;
        public float mValue;
        public Vector2if(int index, float value)
        {
            mIndex = index;
            mValue = value;
        }
